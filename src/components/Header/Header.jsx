        ...
        <div className="site-haeder__inner">
          ...
          <nav className='nav'>
            <ul className='nav__list'>
              ...
              <li className='nav__item user-icon' onClick={() => setDrop(!drop)}>
                <button className='nav__link'>
                  <img className='nav__img' src={UserIcon} width={32} height={32} alt='User info icon'/>
                </button>
                  <div className={`drop ${drop ? '' : 'visually-hidden'}`}>
                    ...
                    <ul className='drop__list'>
                      <li className='drop__item'>
                        <Link className='drop__link' to={'#'}>Mening ma’lumotlarim</Link>
                      </li>
                      <li className='drop__item'>
                        <Link className='drop__link' to={'#'}>E’lonlarim</Link>
                      </li>
                      <li className='drop__item'>
                        <Link className='drop__link' to={'#'}>Biz haqimizda</Link>
                      </li>
                      <li className='drop__item'>
                        <Link className='drop__link logout-btn' to={'#'}>Chiqish</Link>
                      </li>
                    </ul>
                  </div>
              </li>
