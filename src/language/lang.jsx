export const lang = {
  Uz: {
    ...
    homebanner: {
      ...
      pricetype: "Valyuta bo'yicha",
      filterbtn: "Filterlash",
      searchbtn: "Izlash",
      title: "Uy-joy e'lonlaringizni bizning saytga joylashtiring",
    ...
    footer: {
      ...
      partners: "Hamkorlik",
      ads: "Reklama",
      callme: "Murojaat qilish",
    },
    addannoun: {
      annountitle: "E'lon joylash",
  ...
  Ru: {
    ...
    announ: {
      announs: "Мои объявления",
      active: "Активный",
      deactive: "Не активен",
      activeannoun: "Активация",
      deactiveannoun: "Деактивировать",
